...
>
	...
	<button type="button" class="hover:cursor-pointer" onclick={(e) => (startDrag('picture'))}>
		<div class="relative h-45 w-35 bg-[#ffffed] brightness-95 p-2 overflow-hidden rotate-3 drop-shadow-[19px_10px_21px_rgba(0,0,0,0.3)] hover:cursor-pointer" >
	...
	<button type="button" class="hover:cursor-pointer" onclick={(e) => (startDrag('document'))}>
		<div class="relative h-45 w-35 bg-[url(/images/stack-papers.png)] bg-cover p-6 brightness-95 overflow-hidden -rotate-2 drop-shadow-[19px_10px_21px_rgba(0,0,0,0.3)] hover:cursor-pointer" >
